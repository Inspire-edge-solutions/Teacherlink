...
const JobPreference = ({ formData, updateFormData }) => {
  ...
  const [preferences, setPreferences] = useState({
    ...
    parentGuardian: {
      ...
      // Removed coaching_institute from parentGuardian to match the UI
    },
  });
  ...
  const validateJobPreferences = () => {
    ...
    const isJobSearchValid = Object.values(jobSearchStatus).every(
      (status) => hasValue(status.offline) && hasValue(status.online)
    );
        ...
        if (response.status === 200 && response.data && response.data.length > 0) {
          ...
          const pref = {
            ...
            parentGuardian: {
              ...
              // coaching_institute was removed from parentGuardian
            },
          };
                  ...
                  <tr>
                    ...
                    <td data-label="Offline">
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange('jobShift','part_time_weekdays','offline', e.target.value)
                        }
                        required
                      >
                        <option value="" disabled>Select</option>
                    ...
                    <td data-label="Online">
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange('jobShift','part_time_weekdays','online', e.target.value)
                        }
                        required
                      >
                        <option value="" disabled>Select</option>
                  ...
                  <tr>
                    ...
                    <td data-label="Offline">
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange('jobShift','part_time_weekends','offline', e.target.value)
                        }
                        required
                      >
                        <option value="" disabled>Select</option>
                    ...
                    <td data-label="Online">
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange('jobShift','part_time_weekends','online', e.target.value)
                        }
                        required
                      >
                        <option value="" disabled>Select</option>
                  ...
                  <tr>
                    ...
                    <td data-label="Offline">
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange('jobShift','part_time_vacations','offline', e.target.value)
                        }
                        required
                      >
                        <option value="" disabled>Select</option>
                    ...
                    <td data-label="Online">
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange('jobShift','part_time_vacations','online', e.target.value)
                        }
                        required
                      >
                        <option value="" disabled>Select</option>
                  ...
                  <tr>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange(
                            'organizationType','school_college_university','offline',e.target.value
                          )
                        }
                        required
                      >
                    ...
                    <td data-label="Online">
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange(
                            'organizationType','school_college_university','online',e.target.value
                          )
                        }
                        required
                      >
                  ...
                  <tr>
                    ...
                    <td data-label="Offline">
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange(
                            'organizationType','coaching_institute','offline',e.target.value
                          )
                        }
                        required
                      >
                    ...
                    <td data-label="Online">
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange(
                            'organizationType','coaching_institute','online',e.target.value
                          )
                        }
                        required
                      >
                  ...
                  <tr>
                    ...
                    <td data-label="Offline">
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange(
                            'organizationType','Ed_TechCompanies','offline',e.target.value
                          )
                        }
                        required
                      >
                    ...
                    <td data-label="Online">
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange(
                            'organizationType','Ed_TechCompanies','online',e.target.value
                          )
                        }
                        required
                      >
            ...
            <div className="preference-table">
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td data-label="Offline">
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange(
                            'parentGuardian','Home_Tutor','offline',e.target.value
                          )
                        }
                        required
                      >
                  ...
                  <tr>
                    ...
                    <td data-label="Offline">
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange(
                            'parentGuardian','Private_Tutor','offline',e.target.value
                          )
                        }
                        required
                      >
                  ...
                  <tr>
                    ...
                    <td data-label="Offline">
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange(
                            'parentGuardian','Group_Tutor_offline','offline',e.target.value
                          )
                        }
                        required
                      >
                  ...
                  <tr>
                    ...
                    <td data-label="Online">
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange(
                            'parentGuardian','Private_Tutions_online','online',e.target.value
                          )
                        }
                        required
                      >
                  ...
                  <tr>
                    ...
                    <td data-label="Online">
                      <select
                        ...
                        onChange={(e) =>
                          handlePreferenceChange(
                            'parentGuardian','Group_Tutor_online','online',e.target.value
                          )
                        }
                        required
                      >
                  ...
                  {/* No row for 'coaching_institute' here, since we removed it */}
                </tbody>
              </table>
            </div>
          </div>
