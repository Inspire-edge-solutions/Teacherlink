...
//                   <img src="https://plus.unsplash.com/premium_photo-1661335260175-5735a1d487e1?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="institution"/>        alt="resource"
//                     onError={(e) => {
     ...
     <div className="image-column -no-margin col-xl-6 col-lg-6 col-md-12 col-sm-12 wow fadeInRight">
             <div className="image-box -type-1">
                 ...
                 >
                   ...
                   <img src="/images/teacherlink_images/about-us.png" alt="institution"/>        alt="resource"
                     onError={(e) => {
                       console.log('Image failed to load:', e.target.src);
                     }}
                 </figure>
